...
- `from`/`to` là ngày Asia/Ho_Chi_Minh inclusive, mặc định 30 ngày inclusive, tối đa 92 ngày; chuyển thành UTC `[from,to)` và lỗi là `422 REPORT_RANGE_INVALID`.
...
3. **OQ-3 — Range**: `from/to` là ngày Asia/Ho_Chi_Minh inclusive hay UTC; default bao nhiêu ngày; giới hạn tối đa bao nhiêu ngày; vượt giới hạn dùng error code/status nào? Đề xuất cần human duyệt: Asia/Ho_Chi_Minh, mặc định 30 ngày inclusive, tối đa 92 ngày, `422 REPORT_RANGE_INVALID`.
