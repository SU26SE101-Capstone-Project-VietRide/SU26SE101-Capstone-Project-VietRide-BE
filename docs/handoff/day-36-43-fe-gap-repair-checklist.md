...
| Post-main-merge inventory reconciliation | PASS — 181 total / 164 required / 17 exempt after v1.54 Shuttle pickup; 45 handlers; 28 outbound callsites / 9 exemptions; DriverSchedule create/activate follow the higher no-key contract |
