...
- BẮT BUỘC gắn Swagger decorators (`@ApiTags`, `@ApiOperation`, v.v.) cho các controllers.
...
- BẮT BUỘC gắn đầy đủ Swagger decorators (`@ApiOperation`, `@ApiResponse`, `@ApiParam`, `@ApiQuery`, `@ApiBearerAuth`) cho endpoint mới.
