...
public sealed class Day29ParcelLoadedOutboxRestartTests : IAsyncLifetime
{
    private const string RoutingKey = "parcel.parcel.loaded";
    private readonly OutboxStoreFixture fixture;

    public Day29ParcelLoadedOutboxRestartTests(OutboxStoreFixture fixture)
    {
    ...
    [Fact]
    public async Task PendingLoadedRow_SurvivesFailureAndIsDeliveredAfterWorkerRestart()
    {
        ...
        unavailablePublisher.PublishRawAsync(
                RoutingKey,
                eventId,
                persistedPayload,
