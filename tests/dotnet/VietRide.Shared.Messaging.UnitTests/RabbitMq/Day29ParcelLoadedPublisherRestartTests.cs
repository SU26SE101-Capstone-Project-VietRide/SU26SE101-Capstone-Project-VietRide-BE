...
public sealed class Day29ParcelLoadedPublisherRestartTests
{
    [Fact]
    public async Task Restart_PublishesParcelLoadedToTopicExchangeWithStableMessageId()
    {
        const string routingKey = "parcel.parcel.loaded";
        ...
        restartedChannel.Received(1).ExchangeDeclare(
            "vietride.events",
            ExchangeType.Topic,
            true,
            false,
