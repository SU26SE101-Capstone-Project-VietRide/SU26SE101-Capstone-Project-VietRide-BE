...
export const OFF_ROUTE_REALTIME_HEARTBEAT_MS = 60_000;
export const OFF_ROUTE_STATE_TTL_SECONDS = 86_400;
export const OFF_ROUTE_LOCK_TTL_SECONDS = 10;
...
export function trackingOffRouteLockKey(tripId: string): string {
  return `tracking:off_route_lock:${tripId}`;
}
