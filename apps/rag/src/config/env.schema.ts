...
export const envSchema = baseEnvSchema.merge(
  z.object({
    ...
    RAG_INGEST_WORKER_ENABLED: booleanEnvSchema.default(true),
    RAG_OUTBOX_PUBLISH_ENABLED: booleanEnvSchema.default(false),
    INTENT_FILTER_ENABLED: booleanEnvSchema.default(true),
    QUERY_REWRITE_ENABLED: booleanEnvSchema.default(true),
    HYBRID_SEARCH_ENABLED: booleanEnvSchema.default(true),
    RERANK_ENABLED: booleanEnvSchema.default(true),
    SUMMARIZE_ENABLED: booleanEnvSchema.default(true),
