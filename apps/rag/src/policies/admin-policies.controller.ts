...
export class AdminPoliciesController {
  ...
  list(
    ...
    return this.policies.list('ADMIN', query, req.user);
  }

  @Get(':policyId')
  @ApiOperation({ summary: 'Get a platform Policy' })
  ...
  get(
    ...
    return this.policies.get('ADMIN', policyId, req.user);
  }

  @Post()
  @ApiIdempotencyRequired()
  @ApiOperation({ summary: 'Create a platform Policy and immutable audit row' })
  ...
  create(
    ...
    return this.policies.create('ADMIN', dto, req.user);
  }

  @Patch(':policyId')
  @ApiIdempotencyRequired()
  @ApiOperation({ summary: 'Update a platform Policy with optimistic content versioning' })
  @ApiParam({ name: 'policyId', format: 'uuid' })
  ...
  update(
    ...
    return this.policies.update('ADMIN', policyId, dto, req.user);
  }

  @Delete(':policyId')
  @ApiIdempotencyRequired()
  @ApiOperation({ summary: 'Soft-delete a platform Policy and append a DELETE audit row' })
  @ApiParam({ name: 'policyId', format: 'uuid' })
  @ApiResponse({ status: 200, schema: successEnvelopeSchema(200, policySchema) })
  @ApiResponse({ status: 401, schema: errorEnvelopeSchema(401, 'UNAUTHORIZED', 'Unauthorized') })
  @ApiResponse({ status: 403, schema: errorEnvelopeSchema(403, 'FORBIDDEN', 'Forbidden') })
  ...
  delete(
    ...
    return this.policies.delete('ADMIN', policyId, req.user);
  }
}
