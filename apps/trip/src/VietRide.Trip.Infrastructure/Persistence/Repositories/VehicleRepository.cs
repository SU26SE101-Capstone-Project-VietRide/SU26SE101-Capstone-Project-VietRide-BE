        ...
        try
        {
            await dbContext.Database.ExecuteSqlInterpolatedAsync($"""
                ...
                VALUES (
                    ...
                    CAST({System.Text.Json.JsonSerializer.Serialize(vehicle.ImageUrls)} AS jsonb),
        ...
        try
        {
            await dbContext.Database.ExecuteSqlInterpolatedAsync($"""
                ...
                SET
                    ...
                    image_urls = CAST({System.Text.Json.JsonSerializer.Serialize(vehicle.ImageUrls)} AS jsonb),
