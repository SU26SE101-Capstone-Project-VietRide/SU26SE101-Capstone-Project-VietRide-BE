...
export function buildRouteTable(env: Env): ProxyRoute[] {
  return [
    // Identity
    { prefix: '/v1/auth', target: env.IDENTITY_BASE_URL, authRequired: 'none' },
    ...
    { prefix: '/v1/admin', target: env.IDENTITY_BASE_URL, authRequired: 'user', requiredRoles: ['SYSTEM_ADMIN'] },
    ...
    { prefix: '/v1/identity/health', target: env.IDENTITY_BASE_URL, authRequired: 'none', rewriteTo: '/health' },
    ...
    { prefix: '/v1/trip/health', target: env.TRIP_BASE_URL, authRequired: 'none', rewriteTo: '/health' },
    ...
    { prefix: '/v1/booking/health', target: env.BOOKING_BASE_URL, authRequired: 'none', rewriteTo: '/health' },

    // Payment
    { prefix: '/v1/payments', target: env.PAYMENT_BASE_URL, authRequired: 'mixed' /* vnpay-ipn public */ },
    { prefix: '/v1/wallet', target: env.PAYMENT_BASE_URL, authRequired: 'user' },
    { prefix: '/v1/payment/health', target: env.PAYMENT_BASE_URL, authRequired: 'none', rewriteTo: '/health' },

    // Parcel
    { prefix: '/v1/parcels', target: env.PARCEL_BASE_URL, authRequired: 'user' },
    { prefix: '/v1/parcel/health', target: env.PARCEL_BASE_URL, authRequired: 'none', rewriteTo: '/health' },
