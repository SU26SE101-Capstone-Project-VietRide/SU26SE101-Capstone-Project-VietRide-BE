...
namespace VietRide.Parcel.Infrastructure.Migrations
{
    ...
    [Migration("20260903071304_ReduceParcelNoProofFallbackMultiplier")]
    partial class ReduceParcelNoProofFallbackMultiplier
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("parcels", "vietride_parcel", t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_parcels_quantity_positive", "quantity > 0");
            ...
            modelBuilder.Entity("VietRide.Parcel.Domain.Entities.ParcelClaim", b =>
                {
                    ...
                    b.Property<Guid?>("AppealedByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("appealed_by_user_id");
                    ...
                    b.ToTable("parcel_claims", "vietride_parcel", t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_parcel_claims_proof_status", "proof_status IS NULL OR proof_status IN ('VERIFIED', 'UNVERIFIED', 'NO_PROOF')");
            ...
            modelBuilder.Entity("VietRide.Parcel.Domain.Entities.ParcelClaimAppeal", b =>
                {
                    ...
                    b.HasAlternateKey("Id", "ClaimId")
                        .HasName("ak_parcel_claim_appeals_id_claim_id");
                    ...
                    b.ToTable("parcel_claim_appeals", "vietride_parcel", t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_parcel_claim_appeal_proof_status", "proof_status IS NULL OR proof_status IN ('VERIFIED', 'UNVERIFIED', 'NO_PROOF')");
            ...
            modelBuilder.Entity("VietRide.Parcel.Domain.Entities.ParcelClaimAppealDecisionEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_parcel_claim_appeal_decision_evidence");

                    b.HasIndex("AppealId", "ClaimId")
                        .HasDatabaseName("idx_parcel_claim_appeal_decision_evidence_appeal_claim");

                    b.HasIndex("AppealId", "EvidenceId")
                        .IsUnique()
                        .HasDatabaseName("uq_parcel_claim_appeal_decision_evidence");

                    b.HasIndex("ClaimId", "EvidenceId")
                        .HasDatabaseName("idx_parcel_claim_appeal_decision_evidence_claim_evidence");

                    b.ToTable("parcel_claim_appeal_decision_evidence", "vietride_parcel");
                });

            modelBuilder.Entity("VietRide.Parcel.Domain.Entities.ParcelClaimDecisionEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_parcel_claim_decision_evidence");

                    b.HasIndex("ClaimId", "EvidenceId")
                        .IsUnique()
                        .HasDatabaseName("uq_parcel_claim_decision_evidence");

                    b.ToTable("parcel_claim_decision_evidence", "vietride_parcel");
                });
            ...
            modelBuilder.Entity("VietRide.Parcel.Domain.Entities.ParcelClaimEvidence", b =>
                {
                    ...
                    b.HasAlternateKey("ClaimId", "Id")
                        .HasName("ak_parcel_claim_evidence_claim_id_id");
            ...
            modelBuilder.Entity("VietRide.Parcel.Domain.Entities.ParcelCustodyExceptionRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("ApprovedCustodyEventId")
                        .HasColumnType("uuid")
                        .HasColumnName("approved_custody_event_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_parcel_custody_exception_requests");

                    b.HasIndex("ApprovedCustodyEventId")
                    ...
                    b.HasIndex("ParcelId", "IncidentType")
                        .IsUnique()
                    ...
                    b.HasIndex("TripId", "Status", "CreatedAt")
                        .HasDatabaseName("idx_parcel_custody_exception_requests_trip_status");

                    b.ToTable("parcel_custody_exception_requests", "vietride_parcel", t =>
                        {
                            t.HasCheckConstraint("chk_parcel_custody_exception_request_status", "status IN ('PENDING_APPROVAL', 'APPROVED', 'REJECTED', 'CANCELLED')");

                            t.HasCheckConstraint("chk_parcel_custody_exception_review_audit", "(status = 'PENDING_APPROVAL' AND reviewed_by_user_id IS NULL AND reviewed_by_role IS NULL AND reviewed_at IS NULL) OR (status <> 'PENDING_APPROVAL' AND reviewed_by_user_id IS NOT NULL AND reviewed_by_role IS NOT NULL AND reviewed_at IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("VietRide.Parcel.Domain.Entities.ParcelClaimAppealDecisionEvidence", b =>
                {
                    b.HasOne("VietRide.Parcel.Domain.Entities.ParcelClaimAppeal", null)
                        .WithMany()
                        .HasForeignKey("AppealId", "ClaimId")
                        .HasPrincipalKey("Id", "ClaimId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_parcel_claim_appeal_decision_evidence_appeal");

                    b.HasOne("VietRide.Parcel.Domain.Entities.ParcelClaimEvidence", null)
                        .WithMany()
                        .HasForeignKey("ClaimId", "EvidenceId")
                        .HasPrincipalKey("ClaimId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("VietRide.Parcel.Domain.Entities.ParcelCustodyExceptionRequest", b =>
                {
                    b.HasOne("VietRide.Parcel.Domain.Entities.ParcelCustodyEvent", null)
                        .WithMany()
                        .HasForeignKey("ApprovedCustodyEventId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_parcel_custody_exception_requests_parcel_custody_events_app~");
                    ...
                    b.HasOne("VietRide.Parcel.Domain.Entities.ParcelIncident", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_parcel_custody_exception_requests_parcel_incidents_incident~");
                    ...
                    b.HasOne("VietRide.Parcel.Domain.Entities.Parcel", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_parcel_custody_exception_requests_parcels_parcel_id");
                });
