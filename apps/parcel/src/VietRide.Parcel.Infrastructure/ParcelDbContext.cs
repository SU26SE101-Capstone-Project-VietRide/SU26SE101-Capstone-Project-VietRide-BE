...
public sealed class ParcelDbContext : VietRideDbContextBase
{
    ...
    public DbSet<ParcelTransitLeg> ParcelTransitLegs => Set<ParcelTransitLeg>();
    ...
    public DbSet<ParcelStopDepartureApprovalRequest> ParcelStopDepartureApprovalRequests
        => Set<ParcelStopDepartureApprovalRequest>();
