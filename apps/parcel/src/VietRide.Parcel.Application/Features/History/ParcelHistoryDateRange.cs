...
internal sealed record ParcelHistoryDateRange(DateTimeOffset? From, DateTimeOffset? To)
{
    public static ParcelHistoryDateRange Parse(string? from, string? to)
    {
        ...
        return new ParcelHistoryDateRange(parsedFrom, parsedTo);
    }
