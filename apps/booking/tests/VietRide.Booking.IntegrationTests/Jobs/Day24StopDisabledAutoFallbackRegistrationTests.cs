...
public sealed class Day24StopDisabledAutoFallbackRegistrationTests
{
    [Fact]
    public void Scheduler_RegistersOneUtcFiveMinuteRecurringJobOnBookingQueue()
    {
        ...
        provider.GetRequiredService<IStopDisabledAutoFallbackScheduler>().EnsureScheduled();
        ...
        registration.GetArguments()[0].Should().Be("booking-stop-disabled-auto-fallback");
        ...
        typeof(StopDisabledAutoFallbackJob).GetMethod(nameof(StopDisabledAutoFallbackJob.ExecuteAsync))!
