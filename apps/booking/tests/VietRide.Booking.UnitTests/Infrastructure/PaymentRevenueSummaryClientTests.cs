...
public sealed class PaymentRevenueSummaryClientTests
{
    ...
    [Fact]
    public async Task PaymentReportingCircuit_OpensAfterFiveFailuresAndRejectsCalls()
    {
    ...
    [Fact]
    public async Task PaymentReportingCircuit_SuccessfulHalfOpenProbeClosesIt()
    {
        var policy = InfrastructureServiceCollectionExtensions
