...
/// <summary>
/// Query for voucher list endpoints.
/// <para>
/// Owner scope is explicit: <see cref="PlatformOnly"/> means owner_operator_id IS NULL;
/// <see cref="OwnerOperatorId"/> means owner_operator_id equals that operator.
