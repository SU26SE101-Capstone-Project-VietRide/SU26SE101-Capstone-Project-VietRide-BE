...
/// <summary>
/// BCL-only HS256 internal JWT signer for outbound Booking service calls.
/// </summary>
public sealed class InternalJwtTokenFactory : IInternalJwtTokenProvider
{
    ...
    private const string DefaultCallerService = "booking";
    ...
    public InternalJwtTokenFactory(IConfiguration configuration)
    {
        var secret = configuration["InternalJwt:Secret"]
            ...
            ?? throw new InvalidOperationException(
                "INTERNAL_JWT_SECRET must be configured for Booking internal calls.");
