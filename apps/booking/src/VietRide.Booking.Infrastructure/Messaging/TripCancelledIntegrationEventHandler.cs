...
internal sealed class TripCancelledIntegrationEventHandler(IMediator mediator)
    : IIntegrationEventHandler<TripCancelledIntegrationEvent>
{
    ...
    private static void Validate(TripCancelledIntegrationEvent integrationEvent)
    {
        ...
        {
            throw new ArgumentException("Trip-cancelled contract contains an invalid cancellation reason.");
        }
    }
}
