...
namespace VietRide.Booking.Infrastructure.Migrations
{
    ...
    [Migration("20260901120447_AddBookingPointSnapshots")]
    partial class AddBookingPointSnapshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "vietride_booking", "booking_transfer_confirmation_status", new[] { "PENDING_CONFIRM", "ESCALATED", "CONFIRMED", "NOT_REQUIRED" });
            ...
            modelBuilder.Entity("VietRide.Booking.Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<string>("DropoffPointAddressSnapshot")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("dropoff_point_address_snapshot");

                    b.Property<Guid?>("DropoffPointIdSnapshot")
                        .HasColumnType("uuid")
                        .HasColumnName("dropoff_point_id_snapshot");

                    b.Property<string>("DropoffPointNameSnapshot")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("dropoff_point_name_snapshot");

                    b.Property<DateTimeOffset?>("DropoffPointPlannedAtSnapshot")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("dropoff_point_planned_at_snapshot");

                    b.Property<string>("DropoffPointTypeSnapshot")
                        .HasMaxLength(16)
                    ...
                    b.Property<string>("PickupPointAddressSnapshot")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("pickup_point_address_snapshot");

                    b.Property<Guid?>("PickupPointIdSnapshot")
                        .HasColumnType("uuid")
                        .HasColumnName("pickup_point_id_snapshot");

                    b.Property<string>("PickupPointNameSnapshot")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("pickup_point_name_snapshot");

                    b.Property<DateTimeOffset?>("PickupPointPlannedAtSnapshot")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("pickup_point_planned_at_snapshot");

                    b.Property<string>("PickupPointTypeSnapshot")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
            ...
            modelBuilder.Entity("VietRide.Booking.Domain.Entities.BookingShuttleIntent", b =>
                {
                    ...
                    b.Property<string>("Direction")
                        ...
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasDefaultValue("INBOUND_TO_STATION")
                    ...
                    b.ToTable("booking_shuttle_intents", "vietride_booking", t =>
                        {
                            t.HasCheckConstraint("chk_booking_shuttle_intents_direction", "direction IN ('INBOUND_TO_STATION', 'OUTBOUND_FROM_STATION')");
                            ...
                            t.HasCheckConstraint("chk_booking_shuttle_intents_road_distance", "road_distance_meters IS NULL OR road_distance_meters >= 0");
                        });
                });
            ...
            modelBuilder.Entity("VietRide.Booking.Domain.Entities.BookingTransfer", b =>
                {
                    ...
                    b.Property<bool>("IsSeatDowngrade")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.Property<string>("OriginalSeatType")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
