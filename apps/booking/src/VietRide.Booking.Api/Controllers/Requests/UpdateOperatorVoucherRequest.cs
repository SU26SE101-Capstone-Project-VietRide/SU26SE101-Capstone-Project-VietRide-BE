...
/// <c>maxDiscountAmount</c>) are frozen — providing a changed value → 409 VOUCHER_LOCKED.
/// Omitting an economic field (null) passes through without triggering the freeze guard.
/// </para>
/// </summary>
public sealed class UpdateOperatorVoucherRequest
{
    ...
    /// <summary>New discount value (VND). Null = keep current value.</summary>
    ...
    /// <summary>New valid-from timestamp. Null = keep current value.</summary>
    public DateTimeOffset? ValidFrom { get; init; }

    /// <summary>New valid-until timestamp. Null = keep current value.</summary>
