...
export const SUBSCRIPTION_PAYMENT_PENDING_WARN_ROUTING_KEY = 'payment.subscription.payment_pending_warn';
export const SUBSCRIPTION_PAYMENT_AUTO_REVERTED_ROUTING_KEY = 'payment.subscription.payment_auto_reverted';
...
export const PARCEL_SUBSCRIPTION_OPERATOR_QUEUE_BINDINGS = [
  ...
  { queue: 'notification:trip-vehicle-substituted', routingKey: TRIP_VEHICLE_SUBSTITUTED_ROUTING_KEY },
