...
import type { RequestWithNotificationInternalUser } from './notification-internal-user.types';
...
export class InternalJwtAuthGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    const request = context.switchToHttp().getRequest<RequestWithNotificationInternalUser>();
