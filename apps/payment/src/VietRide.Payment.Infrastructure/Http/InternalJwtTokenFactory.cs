...
/// <summary>
/// BCL-only HS256 internal JWT signer for outbound Payment service calls.
/// </summary>
internal sealed class InternalJwtTokenFactory : IInternalJwtTokenProvider
{
    private const string DefaultIssuer = "vietride-gateway";
    private const string DefaultAudience = "vietride-internal";
    private const string DefaultCallerService = "payment";
    ...
    public InternalJwtTokenFactory(IConfiguration configuration)
    {
        var secret = configuration["InternalJwt:Secret"]
            ...
            ?? throw new InvalidOperationException(
                "INTERNAL_JWT_SECRET must be configured for Payment internal calls.");
