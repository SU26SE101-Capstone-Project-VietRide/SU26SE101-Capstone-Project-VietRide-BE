...
public sealed class ListAdminSubscriptionCustomRequestsQueryValidator
    : AbstractValidator<ListAdminSubscriptionCustomRequestsQuery>
{
    public ListAdminSubscriptionCustomRequestsQueryValidator()
    {
