...
namespace VietRide.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260813102009_AddOperatorUserLockSourceAndPasswordChange")]
    partial class AddOperatorUserLockSourceAndPasswordChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "refresh_token_revoke_reason", new[] { "NORMAL_ROTATION", "REUSE_DETECTED", "USER_LOGOUT", "ADMIN_REVOKE", "PASSWORD_RESET", "PASSWORD_CHANGE" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "user_lock_source", new[] { "AUTOMATIC_LOGIN_FAILURE", "OPERATOR_ADMIN", "SYSTEM_ADMIN", "LEGACY_UNKNOWN" });
            ...
            modelBuilder.Entity("VietRide.Identity.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<UserLockSource?>("LockSource")
                    ...
                    b.ToTable("users", "vietride_identity", t =>
                        {
                            t.HasCheckConstraint("chk_users_locked_from_status", "((status = 'LOCKED' AND locked_from_status IN ('ACTIVE', 'PENDING_EMAIL_VERIFICATION') AND lock_source IS NOT NULL) OR (status <> 'LOCKED' AND locked_from_status IS NULL AND lock_source IS NULL))");
