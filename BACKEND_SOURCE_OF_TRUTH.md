...
|---|---|---|---|
| **1.60.0** | 2026-08-08 | Codex | **MINOR** — Reconcile the current RAG contract with runtime and physical DDL: Cloudinary raw document storage, OpenRouter chat/embedding, canonical embedding model `nvidia/llama-nemotron-embed-vl-1b-v2:free`, `halfvec(2048)`, and HNSW cosine indexing. No physical DDL, migration, dependency, provider secret, or integration-event change. |
