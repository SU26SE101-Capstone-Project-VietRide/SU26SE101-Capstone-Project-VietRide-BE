...
async function main() {
  ...
  await runCase('happy path accepts driver gps:update with off-route detector wired', async () => {
  ...
  console.log('[INFO] Phase 6 smoke verifies socket behavior only. Route geometry production provider is noop until Trip-Route-Vehicle endpoint exists.');
}
