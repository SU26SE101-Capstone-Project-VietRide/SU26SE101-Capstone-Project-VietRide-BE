...
|---|---|---|
| `Notification` | In-app history per user. | `type` enum (49 values), `title`, `body`, `data` JSONB, `readAt` |
...
- **`Notification.type` enum với 49 value** — toàn bộ notification type theo thứ tự canonical:
